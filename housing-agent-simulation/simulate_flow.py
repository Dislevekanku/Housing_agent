...
class FlowSimulator:
    ...
    def check_compliance(self, candidate: Dict[str, Any], proposed_use: str, lot_sqft: Optional[float] = None) -> Optional[Dict[str, Any]]:
    ...
    def run_test_case(
        ...
        compliance_result = self.check_compliance(candidate, proposed_use, lot_sqft)
